            ...
            <div className="main">
                {
                    ...
                    <div className=" m-auto w-fit p-4 align-middle text-blue-500 justify-center">
                        ...
                        <h3 className="text-3xl">No Contact Found Please add contact from <br /> Create Contact Button</h3>
                    </div>
                }
                {
                            ...
                            <>
                                <div className="user_card">
                                    <div className="picture">
                                        <img className="img-fluid" src={profileImg} alt='img' />
                                    </div>
                                    <div className="main-content">
                                        <h4 className="name">{contact.firstName} {contact.lastName}</h4>
                                        <span className="title">{contact.status}</span>
                                    </div>
                                    <div>
                                        <Link to={`edit/${contact.id}`}>
                                            <button className="btn btn-warning mt-4 m-2">Edit</button>
                                        </Link>

                                        <button onClick={() => dispatch(removeContact(contact.id))} className="btn btn-danger mt-4 m-2">Delete</button>
                                    </div>
                                </div>
                            </>
                        )
